    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="DrivingLicense.jsp">Driving License</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="MarriageCertificate.jsp">Marriage Certificate</a>
                </li>
